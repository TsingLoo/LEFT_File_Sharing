...
def listener():
    ...
    TCP_server_socket.bind(('192.168.3.61',server_port))
...
def switch_path(path):
    if (path == os.path.basename(path)):  # the file comes from a Win operating system
...
if __name__ == "__main__":
    ...
    purepath = switch_path('.\share\hahah\heihei\东横河畔.png')
    (hiraciyt,filename) = os.path.split(purepath)
    print(hiraciyt)
